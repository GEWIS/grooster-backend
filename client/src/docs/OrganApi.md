...
|[**organIdMemberUserIdRolePatch**](#organidmemberuseridrolepatch) | **PATCH** /organ/{id}/member/{userId}/role | Update the role of a user within a specific organ|
...
# **organIdMemberUserIdRolePatch**
> UserOrgan organIdMemberUserIdRolePatch(updateParams)
...
let id: number; //Organ ID (default to undefined)
let userId: number; //User ID (default to undefined)
let updateParams: UpdateMemberRoleParams; //Settings input

const { status, data } = await apiInstance.organIdMemberUserIdRolePatch(
    id,
    userId,
    updateParams
);
...
|Name | Type | Description  | Notes|
|------------- | ------------- | ------------- | -------------|
| **updateParams** | **UpdateMemberRoleParams**| Settings input | |
| **id** | [**number**] | Organ ID | defaults to undefined|
| **userId** | [**number**] | User ID | defaults to undefined|
